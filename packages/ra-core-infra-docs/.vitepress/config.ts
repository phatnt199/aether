    ...
    sidebar: {
      ...
      '/api-reference/': [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: 'DefaultRestDataProvider', link: '/api-reference/providers/default-rest-data-provider' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'DefaultNetworkRequestService', link: '/api-reference/services/default-network-request-service' },
